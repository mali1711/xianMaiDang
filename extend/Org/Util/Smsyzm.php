...
class  Smsyzm{
     ...
     * @type string
     * */
    public $accountsid = '594c1c503e4539df437ba99c235eb0ec';

    /*
     * 填写在开发者控制台首页上的Auth Token
     * @type strig
     * */
    public $token = 'eb78c6b89891c71f8769ce7909c39a25';

    /*
     * 填写在开发者控制台首页上的Auth Token
     * //应用的ID，可在开发者控制台内的短信产品下查看
     * */
    public $appid = '2c021c71e4a04741842f836df509b957';

    /*
     * 可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
     * @type string
     * */
    public $templateid = '277877';
     ...
     * tel 手机号
     * */
    public function smsSend($msg,$tel)
    {
        //初始化必填
        //填写在开发者控制台首页上的Account Sid
        ...
        $param = $msg; //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空
        $mobile = $tel;
        $uid = "";
