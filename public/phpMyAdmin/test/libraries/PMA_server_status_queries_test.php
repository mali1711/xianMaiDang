...
/**
 * tests for server_status_queries.fasxawas.php
 *
...
require_once 'libraries/server_status_queries.fasxawas.php';
 ...
 *
 * this class is for testing server_status_queries.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
