...
/**
 * tests for server_databases.fasxawas.php
 *
...
require_once 'libraries/server_databases.fasxawas.php';
 ...
 *
 * this class is for testing server_databases.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
