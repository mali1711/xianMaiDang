...
/**
 * tests for server_engines.fasxawas.php
 *
...
require_once 'libraries/server_engines.fasxawas.php';
 ...
 *
 * this class is for testing server_engines.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
