...
/**
 * tests for server_status_variables.fasxawas.php
 *
...
require_once 'libraries/server_status_variables.fasxawas.php';
 ...
 *
 * this class is for testing server_status_variables.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
