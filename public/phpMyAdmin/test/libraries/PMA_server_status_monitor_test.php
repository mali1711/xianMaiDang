...
/**
 * tests for PMA_server_status_monitor.fasxawas.php
 *
...
require_once 'libraries/server_status_monitor.fasxawas.php';
 ...
 *
 * this class is for testing PMA_server_status_monitor.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
