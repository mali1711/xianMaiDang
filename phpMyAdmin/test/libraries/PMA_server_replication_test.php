...
/**
 * tests for replication_gui.fasxawas.php
 *
...
require_once 'libraries/replication_gui.fasxawas.php';
 ...
 *
 * this class is for testing replication_gui.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
