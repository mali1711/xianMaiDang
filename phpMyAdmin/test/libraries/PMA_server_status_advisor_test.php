...
/**
 * tests for server_status_advisor.fasxawas.php
 *
...
require_once 'libraries/server_status_advisor.fasxawas.php';
 ...
 *
 * this class is for testing server_status_advisor.fasxawas.php functions
 *
 * @package PhpMyAdmin-test
 */
